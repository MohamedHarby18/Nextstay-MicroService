...
export default function ProfilePage() {
  ...
  // Safely sync profile data to form once loaded
  useEffect(() => {
    if (profile) {
      setForm({
        name: profile.name || '',
  ...
  return (
    <GuestHostLayout role={role}>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="card p-8 shadow-card border border-border">
          ...
          <div className="space-y-4">
            ...
            <div><label className="label">Bio</label><textarea rows={3} className="input resize-none" value={form.bio} onChange={e => setForm({ ...form, bio: e.target.value })} placeholder="Tell the platform a little about yourself…" /></div>
